...
bool betterThanPrice(const shared_ptr<Review>& r1, const shared_ptr<Review> & r2);
bool FillReview(shared_ptr<Review> & rt);
void ShowReview(const shared_ptr<Review> & rt);
